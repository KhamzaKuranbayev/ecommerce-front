...
export class CartService {
  ...
  private cartDataClient: CartModelPublic = { total: 0, prodData: [{ id: 0, incart: 0 }] }; // This will be sent to the backend Server as post data 

  // Data variable to store the cart information on the server
  private cartDataServer: CartModelServer = { total: 0, data: [{ product: undefined, numInCart: 0 }] };
